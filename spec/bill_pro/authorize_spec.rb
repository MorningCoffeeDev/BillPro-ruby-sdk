    ...
    describe "call" do
      before :each do
        stub_request(:post, "https://gateway.billpro.com/").
          with(:body => "<Request type='Authorize'><AccountID>91178660</AccountID><AccountAuth>GoPJwdRDRKlcHpcg</AccountAuth></Request>",
               :headers => {'Accept'=>'*/*; q=0.5, application/xml', 'Accept-Encoding'=>'gzip, deflate', 'Content-Length'=>'110', 'User-Agent'=>'Ruby'}).
